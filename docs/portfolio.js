...
function setUpButtons() {
  ...
  let wormsProject = document.querySelector(".worm");
  let container = document.querySelector(".container");
  ...
  buttons.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      wormsProject.classList.add("hidden");
      container.classList.remove("project-holder");
...
function setUpProjectButton() {
  ...
  projectButton.addEventListener("click", () => {
    ...
    wormsProject.classList.remove("hidden");
    homeSection.classList.add("hidden");
    aboutMeSection.classList.add("hidden");
    contactSection.classList.add("hidden");
    projectsSection.classList.add("hidden");
    container.classList.add("project-holder");
    window.scrollTo(0, 0);
  });
}
